...
void COneShotFluidIteration::RegisterInput(CSolver *****solver_container, CGeometry ****geometry_container, CConfig **config_container, unsigned short iZone, unsigned short iInst, unsigned short kind_recording){
...
void COneShotFluidIteration::SetDependencies(CSolver *****solver_container, CGeometry ****geometry_container, CNumerics ******numerics_container, CConfig **config_container, unsigned short iZone, unsigned short iInst, unsigned short kind_recording){
...
void COneShotFluidIteration::InitializeAdjoint_Update(CSolver *****solver_container, CGeometry ****geometry_container, CConfig **config_container, unsigned short iZone, unsigned short iInst){
  ...
  if ((Kind_Solver == DISC_ADJ_NAVIER_STOKES) || (Kind_Solver == DISC_ADJ_RANS) || (Kind_Solver == DISC_ADJ_EULER) ||
    ...
    solver_container[iZone][iInst][MESH_0][ADJFLOW_SOL]->SetAdjoint_OutputUpdate(geometry_container[iZone][iInst][MESH_0],
                                                                  config_container[iZone]);
  }

  if (((Kind_Solver == DISC_ADJ_RANS) || (Kind_Solver == ONE_SHOT_RANS)) && !frozen_visc) {
    solver_container[iZone][iInst][MESH_0][ADJTURB_SOL]->SetAdjoint_OutputUpdate(geometry_container[iZone][iInst][MESH_0],
        config_container[iZone]);
  }
}

void COneShotFluidIteration::InitializeAdjoint_Zero(CSolver *****solver_container, CGeometry ****geometry_container, CConfig **config_container, unsigned short iZone, unsigned short iInst){
  ...
  if ((Kind_Solver == DISC_ADJ_NAVIER_STOKES) || (Kind_Solver == DISC_ADJ_RANS) || (Kind_Solver == DISC_ADJ_EULER) ||
    ...
    solver_container[iZone][iInst][MESH_0][ADJFLOW_SOL]->SetAdjoint_OutputZero(geometry_container[iZone][iInst][MESH_0],
                                                                  config_container[iZone]);
  }

  if (((Kind_Solver == DISC_ADJ_RANS) || (Kind_Solver == ONE_SHOT_RANS)) && !frozen_visc) {
    solver_container[iZone][iInst][MESH_0][ADJTURB_SOL]->SetAdjoint_OutputZero(geometry_container[iZone][iInst][MESH_0],
        config_container[iZone]);
  }
}
...
void COneShotFluidIteration::Iterate_No_Residual(COutput *output,
  ...
  if ((Kind_Solver == DISC_ADJ_NAVIER_STOKES) || (Kind_Solver == DISC_ADJ_RANS) || (Kind_Solver == DISC_ADJ_EULER) ||
    ...
    solver_container[val_iZone][val_iInst][MESH_0][ADJFLOW_SOL]->ExtractAdjoint_Solution_Clean(geometry_container[val_iZone][val_iInst][MESH_0], config_container[val_iZone]);
  ...
  if (((Kind_Solver == DISC_ADJ_RANS) || (Kind_Solver == ONE_SHOT_RANS)) && !frozen_visc) {
    ...
    solver_container[val_iZone][val_iInst][MESH_0][ADJTURB_SOL]->ExtractAdjoint_Solution_Clean(geometry_container[val_iZone][val_iInst][MESH_0],
                                                                              config_container[val_iZone]);
  }
